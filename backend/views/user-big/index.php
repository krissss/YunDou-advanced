...
<div class="widget flat">
    <div class="widget-body">
        ...
        <div class="well bordered-left bordered-blue">
            ...
            <a class="btn btn-default" href="<?=Url::to(['user-big/search','type'=>'department','content'=>'1'])?>">施明飞业务部</a>
            <a class="btn btn-default" href="<?=Url::to(['user-big/search','type'=>'department','content'=>'2'])?>">赵珍玉业务部</a>
            <a class="btn btn-default" href="<?=Url::to(['user-big/search','type'=>'department','content'=>'3'])?>">丁召银业务部</a>
            <div id="search" class="collapse">
                <hr>
                <?= Html::beginForm(['user-big/search'], 'post', ['class' => 'form-inline']) ?>
        ...
        <table class="table table-hover table-bordered text-align-center">
            ...
            <tr>
                ...
                <th class="text-align-center">所属部门</th>
                <th class="text-align-center">推荐码</th>
                <th class="text-align-center">推荐伙伴</th>
                <th class="text-align-center">累计充值金额</th>
            ...
            <?php foreach($users as $user):?>
                <tr>
                    ...
                    <td>
                        ...
                        ?>
                        <button class="btn btn-xs btn-default state_big" data-id="<?=$user->userId?>" data-state="<?=$state_1?>"><?=$btn_1?></button>
                        <button class="btn btn-xs btn-default state_big" data-id="<?=$user->userId?>" data-state="<?=$state_2?>"><?=$btn_2?></button>
                        <?php endif; ?>
                    </td>
                    <?php endif; ?>
                </tr>
