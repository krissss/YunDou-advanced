...
<div class="widget flat">
    <div class="widget-body">
        ...
        <div class="well bordered-left bordered-blue">
            ...
            <a class="btn btn-default" href="<?=Url::to(['user-aaa/search','type'=>'department','content'=>'1'])?>">施明飞业务部</a>
            <a class="btn btn-default" href="<?=Url::to(['user-aaa/search','type'=>'department','content'=>'2'])?>">赵珍玉业务部</a>
            <a class="btn btn-default" href="<?=Url::to(['user-aaa/search','type'=>'department','content'=>'3'])?>">丁召银业务部</a>
        ...
        <table class="table table-hover table-bordered text-align-center">
            ...
            <tr>
                ...
                <th class="text-align-center">关联用户数</th>
