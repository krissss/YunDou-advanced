...
<div class="widget flat">
    <div class="widget-body">
        ...
        <div class="well bordered-left bordered-blue">
            ...
            <label>快速查找:</label>
            <a class="btn btn-default" href="<?=Url::to(['user-aa/link-user','id'=>$recommendUser['userId']])?>">所有</a>
            <a class="btn btn-default" href="<?=Url::to(['user-aa/search-link','type'=>'province','content'=>'江苏'])?>">江苏</a>
            <a class="btn btn-default" href="<?=Url::to(['user-aa/search-link','type'=>'province','content'=>'安徽 '])?>">安徽</a>
            <div id="search" class="collapse">
                <hr>
                <?= Html::beginForm(['user-aa/search-link'], 'post', ['class' => 'form-inline']) ?>
